...
while($row = $oContracts->db_fetch_array($result))
{
    ...
    $resultRate = $oContracts->getRates(array('tr_type_id'=>$row['tr_type_id']));
    $rates = array();
    while($rowRate = $oContracts->db_fetch_array($resultRate))
    {
        $rates[] = array(
    ...
    $resultPayment = $oContracts->getTransactionPayment(array('tr_id'=>$row['id']));
    $payments = array();
    while($rowPayment = $oContracts->db_fetch_array($resultPayment))
    {
        $payments[] = array(
