Ext.define('Locale.hy_AM.workflow.warrant.Manage', {
    constructor: function() {
        Ext.applyIf(this.translations["hy_AM"], {
            ...
            "viewTabTitle": "Լիազորագրերի ստեղծում",
            "warrants": "Լիազորագրեր",
            ...
            "objects": "Օբյեկտ(ներ)",
            "msg_create_success": "Լիազորագիրը մուտքագրված է",
            "msg_update_success": "Լիազորագիրը խմբագրված է",
            ...
            "msg_doc_content_empty": "Լիազորագրի բովանդակությունը լրացված չէ",
            ...
            "subject_relationships_rights": "Փոխհարաբերություններ, լիազորություններ",
            "rights":"Լիազորություններ",
            "name":"Անուն/Անվանում",
            "subjects":"Սուբյեկներ",
            "subject_relationships":"Փոխհարաբերություններ",
            "inheritance_relations": "Ժառանգական կապեր",
            "add_subject_relation": "Ավելացնել փոխհարաբերություն",
