Ext.define('Locale.hy_AM.workflow.contract.Manage', {
    constructor: function() {
        Ext.applyIf(this.translations["hy_AM"], {
            ...
            "viewTabTitle": "Պայմանագրերի ստեղծում",
            ...
            "objects": "Օբյեկտ(ներ)",
            "msg_create_success": "Պայմանագիրը մուտքագրված է",
            "msg_update_success": "Պայմանագիրը խմբագրված է",
            ...
            "msg_doc_content_empty": "Պայմանագրի բովանդակությունը լրացված չէ",
