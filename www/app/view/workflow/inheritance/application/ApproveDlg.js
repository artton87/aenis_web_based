...
Ext.define('Aenis.view.workflow.inheritance.application.ApproveDlg', {
    extend:'Ext.window.Window',

    alias: 'widget.workflowInheritanceApplicationApproveDlg',
    ...
    initComponent: function(){
        Ext.apply(this, {
            title: this.T("approve_inheritance_application"),
            width: 600,
            height: 550,
            draggable: true,
            ...
            items: [
                {
                    ...
                    url: 'workflow/inheritance/application/approve.php',
                    waitMsg: this.T("file_is_uploading"),
                    messages: {
                        inheritance_application_approved: this.T("inheritance_application_approved")
                    },
                    frame: true,
                    layout:{
                        type:'vbox',
                    ...
                    items:[
...

                        {
                            ...
                            items: [
                                ...
                                {
                                    xtype: 'filefield',
                                    name: 'file_inheritance_application',
                                    ref: 'fileInheritanceApplication',
                                    fieldLabel: this.T('attach_file'),
                                    labelWidth: 100,
                                    labelAlign: 'right',
                                    margin: 5,
