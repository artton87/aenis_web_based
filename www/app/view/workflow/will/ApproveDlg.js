...
Ext.define('Aenis.view.workflow.will.ApproveDlg', {
    extend:'Ext.window.Window',

    alias: 'widget.workflowWillApproveDlg',
            ...
            items: [
                {
                    xtype:'form',
                    ref: 'approveWillForm',
                    url: 'workflow/will/approve.php',
                    waitMsg: this.T("file_is_uploading"),
                    messages: {
                        will_approved: this.T("will_approved")
                    },
                    frame: true,
                    layout:{
                        type:'vbox',
