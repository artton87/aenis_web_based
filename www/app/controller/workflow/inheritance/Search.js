Ext.define('Aenis.controller.workflow.inheritance.Search', {
	extend: 'Ext.app.Controller',

	requires: [
		'Aenis.view.workflow.inheritance.Search',
	...
	mixins: [
		'Locale.hy_AM.Common',
		'Locale.hy_AM.workflow.inheritance.Search',
	...
	onClickSelectTransactionType: function() {
		...
		oController.showDialog({uiType: 'inheritance'}).on({
	...
	initWithTransactionType: function(trTypeModel) {
		...
		// When loading inheritance be finished, form inheritance enable automatically after calling setLoading(false)
	...
	onClickSearchBtn: function(){
		...
		var data = {
			...
			subject_death_certificate: values.death_certificate,
			loadMode: 'from_search',
			parties: []
		};
		...
		var oController = this.application.loadController('workflow.inheritance.SearchResults');
