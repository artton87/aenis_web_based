Ext.define("Aenis.controller.workflow.warrant.ApproveDlg", {
    extend: 'Ext.app.Controller',
    requires: [
        'Aenis.view.workflow.warrant.ApproveDlg'
    ],
     ...
     * @param {Object} params    {Aenis.model.workflow.warrant.Manage} model
     * @return {Aenis.view.workflow.warrant.ApproveDlg}
     */
    showDialog: function(params) {
        ...
        this.oDlg.control({
            '[ref=approveAction]': {
                click: {fn: this.onApproveWarrant, buffer:BestSoft.eventDelay}
            },
            '[action=cancel]': {
