Ext.define('Aenis.controller.workflow.notarial_office.SelectDlg', {
	extend: 'Ext.app.Controller',
    requires: [
        'Aenis.view.workflow.notarial_office.SelectDlg'
    ],
     ...
     * @returns {Aenis.view.workflow.notarial_office.SelectDlg}
     */
    showDialog: function(/* params */) {
        ...
        this.oDlg.addEvents(
            /**
             * @event itemSelected
             * Fired when user selects notarial office and presses OK button.
             * Return FALSE from event handler to prevent dialog from closing.
             * @param {Aenis.model.workflow.notarial_office.GridItem} model    Selected item
             */
            'itemSelected',
