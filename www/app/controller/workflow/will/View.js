Ext.define("Aenis.controller.workflow.will.View", {
    extend: 'Ext.app.Controller',
    requires: [
        'Aenis.view.workflow.will.View'
    ],
    ...
    showDialog: function(params) {
        ...
        this.oDlg.control({
            ...
            '.': {
                ...
                afterrender: this.afterRenderWillDialog
            }
        }, null, this);
        this.oDlg.show();
        return this.oDlg;
    ...
    afterRenderWillDialog: function(){
        
        var me = this;
        var willModel = this.oDlg.params.model;
        Ext.create('Aenis.model.workflow.Transaction', {id:willModel.getId()}).reload(
                {
                    params: {
                        info: 'properties,' +
