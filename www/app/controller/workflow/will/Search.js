Ext.define('Aenis.controller.workflow.will.Search', {
	extend: 'Ext.app.Controller',

	requires: [
		'Aenis.view.workflow.will.Search',
	...
	mixins: [
		'Locale.hy_AM.Common',
		'Locale.hy_AM.workflow.will.Search',
	...
	onClickSearchBtn: function(){
		...
		var oController = this.application.loadController('workflow.will.SearchResults');
