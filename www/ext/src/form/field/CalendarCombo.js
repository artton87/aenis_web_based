/**
 * @class Ext.form.field.CalendarCombo
 ...
 */
Ext.define('Ext.form.field.CalendarCombo', {
    ...
    initComponent: function(){
        this.valueField = Ext.data.CalendarMappings.CalendarId.name;
        this.displayField = Ext.data.CalendarMappings.Title.name;
    ...
    getListItemTpl: function(displayField) {
        return '<div class="x-combo-list-item ext-color-{' + Ext.data.CalendarMappings.CalendarId.name +
    ...
    getStyleClass: function(value){
        ...
        if (!Ext.isEmpty(val)) {
            ...
            return 'ext-color-' + (val.data ? val.data[Ext.data.CalendarMappings.CalendarId.name] : val);
        }
        return '';
    },
    ...
    setValue: function(value) {
        if (!value && this.store.getCount() > 0) {
            ...
            value = this.store.getAt(0).data[Ext.data.CalendarMappings.CalendarId.name];
        }
