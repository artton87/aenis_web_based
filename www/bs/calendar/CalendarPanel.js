 ...
 * {@link #calendarStore} config containing records of type {@link Ext.EventRecord EventRecord}. In order
 ...
 * @xtype bscalendarpanel
 */
Ext.define('BestSoft.calendar.CalendarPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.bscalendarpanel',
    ...
    initComponent: function() {
        ...
        this.addEvents({
             ...
             * @param {Ext.CalendarPanel} this
             * @param {Ext.EventRecord} rec The new {@link Ext.EventRecord record} that was added
             */
            eventadd: true,
            /**
             * @event eventupdate
             ...
             * @param {Ext.CalendarPanel} this
             * @param {Ext.EventRecord} rec The new {@link Ext.EventRecord record} that was updated
             */
            eventupdate: true,
            /**
             * @event eventdelete
             ...
             * @param {Ext.CalendarPanel} this
             * @param {Ext.EventRecord} rec The new {@link Ext.EventRecord record} that was removed
             */
            eventdelete: true,
            /**
             * @event eventcancel
             ...
             * @param {Ext.CalendarPanel} this
             * @param {Ext.EventRecord} rec The new {@link Ext.EventRecord record} that was canceled
             */
            eventcancel: true,
            /**
             * @event viewchange
             ...
             * @param {Ext.CalendarPanel} this
             * @param {Ext.Ext.view.AbstractCalendar} view The view being activated (any valid {@link Ext.view.AbstractCalendar AbstractCalendar} subclass)
             ...
             * @param {Ext.CalendarPanel} this
             * @param {Ext.EventRecord} rec The {@link Ext.EventRecord record} for the event that was clicked on
             ...
             * @param {Ext.CalendarPanel} this
             * @param {Ext.EventRecord} rec The {@link Ext.EventRecord record} for the event that the cursor is over
             ...
             * @param {Ext.CalendarPanel} this
             * @param {Ext.EventRecord} rec The {@link Ext.EventRecord record} for the event that the cursor exited
             ...
             * @param {Ext.CalendarPanel} this
             * @param {Ext.EventRecord} rec The {@link Ext.EventRecord record} for the event that was moved with
             ...
             * @param {Ext.CalendarPanel} this
             * @param {Ext.EventRecord} rec The {@link Ext.EventRecord record} for the event that was resized
    ...
    onEventAdd: function(form, rec) {
        rec.data[Ext.data.EventMappings.IsNew.name] = false;
        this.hideEditForm();
     ...
     * @param {Ext.EventRecord} record The event record to edit
     * @return {Ext.CalendarPanel} this
     */
     ...
     * {@link Ext.view.AbstractCalendar AbstractCalendar}.
     * @return {Ext.view.AbstractCalendar} The active view
     */
